...
class _CommentContentPage extends State<CommentPage> {
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider.value(
      ...
      child: new Scaffold(
        appBar:
            new AppBar(title: new Text(_provide.song.title), centerTitle: true),
        body: new Column(
          children: <Widget>[
            new Expanded(
              child: _initView(),
  ...
  _initView() {
    return Selector<CommentProvide, int>(
      ...
      builder: (_, value, child) {
        ...
        return value > 0
            ? _buildListView()
            : AppConfig.initLoading(_provide.showEmpty, '暂无评论，来发表第一个评论吧');
      },
    );
  }
              ...
              new ClipOval(
                child: new CachedNetworkImage(
                  ...
                  placeholder: (context, url) =>
                      AppConfig.getUserPlaceHoder(60.0, 60.0),
  ...
  _submit(String content) {
    ...
    var s = _provide
        ...
        .listen((data) {
          _loading.hide(context);
          _loadData(true);
          Fluttertoast.showToast(msg: "评论成功", gravity: ToastGravity.CENTER);
        }, onError: (e) {
          _loading.hide(context);
        });
    _subscriptions.add(s);
